...
struct ClaudeUsageTests {
    ...
    func `parses legacy opus and account`() {
        let json = """
        {
          ...
          "account_email": " steipete@example.com ",
          "account_org": ""
        }
        """
        let data = Data(json.utf8)
        ...
        #expect(snap?.accountEmail == "steipete@example.com")
    ...
    func `trims account fields`() throws {
        let cases: [[String: String?]] = [
            ["email": " steipete@example.com ", "org": "  Org  "],
    ...
    func `parses claude web API account info`() {
        let json = """
        {
          "email_address": "steipete@example.com",
          "memberships": [
            {
              "organization": {
                "uuid": "org-123",
        ...
        #expect(info?.email == "steipete@example.com")
