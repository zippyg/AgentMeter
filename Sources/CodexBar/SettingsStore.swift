...
final class SettingsStore {
    ...
    init(
        ...
        migrateSecretsOnLaunch: Bool = true)
    {
        ...
        let config = CodexBarConfigMigrator.loadOrMigrate(
            ...
            stores: legacyStores,
            migrateSecrets: migrateSecretsOnLaunch)
        ...
        let resolvedOpenAIWebAccessEnabled = if hasStoredOpenAIWebAccessPreference {
            ...
            Self.inferredInitialOpenAIWebAccessEnabled(
                ...
                resolveCredentialReferences: migrateSecretsOnLaunch)
        }
        if Self.isRunningTests {
...
extension SettingsStore {
    ...
    private static func inferredInitialOpenAIWebAccessEnabled(
        ...
        hadExistingConfig: Bool,
        resolveCredentialReferences: Bool) -> Bool
    {
        ...
        if resolveCredentialReferences {
            if codex.sanitizedCookieHeader != nil { return true }
        } else if codex.inlineCookieHeader != nil {
            return true
        }
    ...
    private static func loadDefaultsState(userDefaults: UserDefaults) -> SettingsDefaultsState {
        ...
        let agentMeterBridgeEnabled = userDefaults.object(forKey: "agentMeterBridgeEnabled") as? Bool ?? true
        ...
        let menuBarShowsHighestUsage = userDefaults.object(forKey: "menuBarShowsHighestUsage") as? Bool ?? true
        ...
        let showOptionalCreditsAndExtraUsage = creditsExtrasDefault ?? false
        if Self.isRunningTests, creditsExtrasDefault == nil {
            userDefaults.set(false, forKey: "showOptionalCreditsAndExtraUsage")
        }
        ...
        return SettingsDefaultsState(
            ...
            agentMeterBridgeEnabled: agentMeterBridgeEnabled,
