...
struct CodexBarSwitcherWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("AgentMeter Switcher")
...
struct CodexBarUsageWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("AgentMeter Usage")
...
struct CodexBarHistoryWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("AgentMeter History")
...
struct CodexBarCompactWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("AgentMeter Metric")
